...
public class Movement
{
    ...
    private Dictionary<string, string> _moveDescription = new Dictionary<string, string>
    {
        ...
        {"Move_1_Tile_1-3", "Move in any direction 1 Tile, with Dice 1-3"},
        {"Move_1_+_Tile_1-3", "Move orthogonally 1 Tile, with Dice 1-3"},
        {"Move_1_x_Tile_1-3", "Move diagonally 1 Tile, with Dice 1-3"},
    };
